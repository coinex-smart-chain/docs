...
`CSC`完全兼容以太坊(Ethereum)[ERC20](https://eips.ethereum.org/EIPS/eip-20)标准。
...
* 标准参考[ERC20](https://eips.ethereum.org/EIPS/eip-20)
* 实现参考[OpenZeppelin-ERC20](https://github.com/OpenZeppelin/openzeppelin-contracts/tree/master/contracts/token/ERC20)
...
# some crc20 token
crc20_address = "<crc20 token address>" 
crc20_address = Web3.toChecksumAddress(crc20_address)
crc20_abi = "<crc20 contract abi>"
# construct a crc20 contract object
contract = w3.eth.contract(crc20_address, abi=crc20_abi)
