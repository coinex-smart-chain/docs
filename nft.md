...
`NFT`的意思是非同质化代币，即每个代币都是独一无二的。

而`ERC721`是以太坊中描述[非同质化代币](https://docs.openzeppelin.com/contracts/3.x/tokens#different-kinds-of-tokens)所有权的标准。

`CSC`完全兼容以太坊(Ethereum)[ERC721](https://eips.ethereum.org/EIPS/eip-721)标准。
...
- 实现参考[OpenZeppelin-ERC721](https://github.com/OpenZeppelin/openzeppelin-contracts/tree/master/contracts/token/ERC721)
